/* uLisp RISC-V Release 4.6 - www.ulisp.com
   David Johnson-Davies - www.technoblogy.com - 13th June 2024

   Licensed under the MIT license: https://opensource.org/licenses/MIT
*/

// stubbed out setjmp/longjmp:
/*
  Plan is to stub out setjmp/longjmp entirely, as it will not be possible
  to have non local jumps in the program.
...
// Lisp Library
const char LispLibrary[] = "(defun square(x) (* x x))";
...
struct jmp_buf toplevel_handler;
struct jmp_buf *handler = &toplevel_handler;
